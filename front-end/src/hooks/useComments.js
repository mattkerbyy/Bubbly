...
// Hook to get comments for a share
...
// Hook to create a comment (on either post or share)
export const useCreateComment = () => {
  ...
  return useMutation({
    ...
    onMutate: async (variables) => {
      ...
      const optimisticComment = buildOptimisticComment({ content, postId, shareId })
    ...
    adjustPostCommentCount(queryClient, postId, 1)
      ...
      if (shareId) {
        await queryClient.cancelQueries({ queryKey: ['share-comments', shareId] })
