...
import { 
  Users, MessageCircle, Heart, Search, Zap, Shield, 
  Check, ArrowRight, Target, Sparkles, Globe, Lock 
} from 'lucide-react'
...
export default function LearnMorePage() {
  const features = [
    ...
    },
    {
      ...
      description: 'React, comment, and share content that resonates with you and your community.',
      benefits: ['Multiple reaction types', 'Threaded comments', 'Share and repost features']
    },
    {
      icon: Search,
      title: 'Smart Discovery',
      description: 'Find interesting content and people with our intelligent recommendation algorithm.',
    ...
    },
    {
      ...
      benefits: ['Push notifications', 'Activity feed', 'Online status indicators']
    },
    {
      icon: Shield,
  ...
  const howItWorks = [
    {
      ...
      description: 'Sign up in seconds with just your email. Customize your profile with photos and bio.',
      icon: Target
    },
    {
      step: 2,
      title: 'Build Your Network',
      description: 'Find and connect with friends, follow interesting people, and join communities.',
      icon: Users
    },
    {
      step: 3,
      title: 'Share & Engage',
      description: 'Post updates, share moments, like and comment on content from your network.',
      icon: Sparkles
    },
    {
      step: 4,
      title: 'Stay Connected',
      description: 'Get real-time updates, discover new content, and grow your social presence.',
      icon: Globe
    },
  ]
        ...
        <section className="container mx-auto px-4 py-16 md:py-24 bg-muted/30">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Explore the tools and capabilities that make Bubbly the best way to connect
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-muted-foreground mb-6">
                We take your privacy and security seriously. Bubbly is built with 
                industry-leading security practices to keep your data safe and private.
              </p>
          ...
          >
            <Card className="bg-gradient-to-br from-primary/10 to-secondary/10 border-primary/20">
              <CardContent className="p-8 md:p-12 text-center space-y-6">
                <h2 className="text-3xl md:text-4xl font-bold">Ready to Join Bubbly?</h2>
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                  Create your account today and start connecting with people who matter most.
                </p>
