      ...
      (entries) => {
        if (entries[0].isIntersecting) {
          if (activeTab === 'users' && hasMoreUsers && !isFetchingMoreUsers) {
            fetchNextUsers()
          } else if (activeTab === 'posts' && hasMorePosts && !isFetchingMorePosts) {
            fetchNextPosts()
      ...
      <div className="min-h-screen bg-background">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground">Enter a search query to find people and posts</p>
          </div>
        </div>
      </div>
    )
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                {isLoading ? (
                  ...
                  <>
                    {totalUsers} {totalUsers === 1 ? 'person' : 'people'} · {totalPosts}{' '}
          ...
          <div className="space-y-6">
            ...
            {activeTab === 'all' && (
              <>
                ...
                {users.length > 0 && posts.length > 0 && <Separator className="my-6" />}
            ...
            {!hasMoreUsers &&
              ...
              ((activeTab === 'users' && users.length > 5) ||
                ...
                (activeTab === 'all' && (users.length > 3 || posts.length > 3))) && (
