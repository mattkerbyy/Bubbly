...
import { useInfiniteFollowers, useFollowUser, useUnfollowUser } from '@/hooks/useFollow'
      ...
      {followers.map((follower, index) => {
        ...
        return (
          ...
          >
            ...
            {/* User Info */}
            <Link to={`/profile/${follower.username}`} className="flex-1 min-w-0">
              <div>
            ...
            {!isOwnProfile && (
              <Button
                ...
                size="sm"
                onClick={() =>
                  isFollowing ? handleUnfollow(follower.id) : handleFollow(follower.id)
                }
