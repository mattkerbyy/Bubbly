...
import { useCreateComment, useUpdateComment } from "@/hooks/CommentFeature/useComments";
import { useUpdateShareComment } from "@/hooks/ShareFeature/useShareComments";
...
const CommentInput = forwardRef(
  ({ postId, shareId, editingComment, onCancelEdit }, ref) => {
