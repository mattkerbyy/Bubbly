...
const AudienceSelector = ({ value = 'Public', onChange, className, disabled = false }) => {
  const currentAudience = AUDIENCE_OPTIONS.find(opt => opt.value === value) || AUDIENCE_OPTIONS[0]
...
// Helper component to display audience icon (for showing on posts)
