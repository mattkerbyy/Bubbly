...
import { getPostShares } from '@/services/shareService'
        ...
        <div className="max-h-[60vh] overflow-y-auto">
          {isLoading ? (
            ...
            <div className="text-center py-12 px-4">
              <p className="text-destructive mb-4">{error?.response?.data?.error || 'Failed to load shares'}</p>
                  ...
                  >
                    ...
                    {!isOwnProfile && (
                      <Button
                        ...
                        size="sm"
                        onClick={() => handleFollowToggle(share.user.id, isFollowing)}
